...
<div id="kt_app_content_container" class="app-container  container-fluid ">
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-5 fw-semibold mb-4" role="tablist" style="cursor:pointer">
                {{-- Tab Show All --}}
                <li class="nav-item" role="presentation">
                    <a class="nav-link {{ request('filter') === 'all' || is_null(request('filter')) ? 'active' : '' }}" href="{{ route('employee.index', ['company' => $company, 'search' => request('search'), 'filter' => 'all']) }}">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link my-0 mx-3 {{ $filter == $position ? 'active' : '' }}" href="{{ route('employee.index', ['company' => $company, 'search' => request('search'), 'filter' => $position]) }}">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <img src="{{ $employees->photo ? asset('storage/' . $employees->photo) : asset('assets/media/avatars/300-1.jpg') }}" alt="Employee Photo" class="rounded" width="40" height="40" style="object-fit: cover;">
                        </td>
                        <td>{{ $employees->npk }}</td>
                        ...
                        <td class="text-center nowrap" style="min-width: 120px;">
                            <a href="{{ route('employee.edit', $employees->npk) }}" class="btn btn-warning btn-sm me-1">
                                <i class="fa fa-edit"></i>
                            </a>
                            <button type="button" class="btn btn-danger btn-sm delete-btn" data-id="{{ $employees->id }}">
                        ...
                        <td class="text-center nowrap" style="min-width: 120px;">
                            <button type="button" class="btn {{ $employees->is_active ? 'btn-light-success' : 'btn-light-danger' }} btn-sm btn-xs status-btn" data-id="{{ $employees->id }}" data-name="{{ $employees->name }}" data-status="{{ $employees->is_active ? 'Non Active' : 'Active' }}">
