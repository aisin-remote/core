...
@section('main')
    ...
    <div id="kt_app_content_container" class="app-container  container-fluid ">
        <div class="container mt-4">
            <div class="card mb-5 mb-xl-8 p-10 shadow-sm rounded-3">
                <h4 class="fw-bold mb-4 text-center">Employee Profile</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 text-center">
                        ...
                        <img src="{{ asset('storage/' . $employee->photo) }}" alt="Employee Photo"
                            class="shadow-sm img-fluid rounded-2" style="max-width: 200px; height: auto;">
                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div id="kt_app_content_container" class="app-container  container-fluid ">
                                    <div class="container mt-4">
                                        <div class="card mb-5 mb-xl-8 p-4 shadow-sm rounded-3">
                                            <h4 class="fw-bold mb-4 text-center">Employee Profile</h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 text-center">
                                                    ...
                                                    <img src="{{ asset('storage/' . $employee->photo) }}"
                                                        alt="Employee Photo" class="shadow-sm img-fluid rounded-2"
                                                ...
                                                <div class="col-md-9">
                                                    <div class="row g-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="{{ $employee->birthday_date }}" readonly>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="{{ $employee->company_group }}" readonly>

                                                            <label class="fw-bold mt-2">Department</label>
                                                            <input type="text" class="form-control"
                                                                value="{{ $employee->function }}" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="card-body border-top p-4">
                                                            ...
                                                            <div class="d-flex flex-wrap align-items-center">
                                                                <div id="kt_signin_email">
                                                                    <div class="fs-6 fw-bold mb-1">S1 - Teknik Industri
                                                                    </div>
                                                                    <div class="fw-semibold text-gray-600">Universitas
                                                                        Indonesia</div>
                                                                </div>
                                                            ...
                                                            <!-- Mengurangi margin separator -->

                                                            <div class="d-flex flex-wrap align-items-center">
                                                                <div id="kt_signin_password">
                                                                    <div class="fs-6 fw-bold mb-1">S2 - Manajemen Industri
                                                                    </div>
                                                                    <div class="fw-semibold text-gray-600">Universitas
                                                                        Harvard</div>
                                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card mb-5">
                                                    ...
                                                    <div id="kt_activity_year"
                                                        class="card-body ps-5 tab-pane fade show active" role="tabpanel"
                                                    ...
                                                    <div id="kt_account_settings_signin_method" class="collapse show">
                                                        <div class="card-body border-top p-4">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div id="kt_signin_email">
                                                                    <div class="fs-6 fw-bold mb-1">2020 - PK Result - Notes
                                                                        - B5+</div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div id="kt_signin_email">
                                                                    <div class="fs-6 fw-bold mb-1">2019 - PK Result - Notes
                                                                        - B5+</div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div id="kt_signin_password">
                                                                    <div class="fs-6 fw-bold mb-1">2018 - PK Result - Notes
                                                                        - B5+</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card mb-5">
                                                        ...
                                                        <div class="card-body">
                                                            <table
                                                                ...
                                                                <thead>
                                                                    <tr
                                                                        class="text-muted fw-bold fs-7 text-uppercase gs-0">
                                                                        <th>Strength</th>
                                                                        <th>Weakness</th>
                                                                    </tr>
                                                                </thead>
