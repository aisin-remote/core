...
@section('main')
    <style>
        table {
            width: 90%;
            /* Atur agar tabel memiliki lebar proporsional */
            table-layout: fixed;
            /* Pastikan kolom memiliki ukuran tetap */
        ...
        td {
            text-align: center;
            /* Center semua isi sel termasuk header */
            vertical-align: middle;
            /* Pastikan teks tetap di tengah secara vertikal */
        ...
        th {
            ...
            /* Pastikan header benar-benar di tengah */
        }
    </style>
        ...
        <div class="card shadow-sm p-3">
            ...
            <div class="row">
                ...
                <div class="col-md-3 text-center">
                    ...
                    <img src="{{ asset('storage/' . $employee->photo) }}" alt="Employee Photo"A class="shadow img-fluid"
                        width="500">
                </div>
                ...
                <div class="timeline timeline-border-dashed">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="mb-5 pe-3">
                                <!--begin::Title-->
                                <a href="#" class="fs-5 fw-semibold text-gray-800 text-hover-primary mb-2">Human
                                    Resource
                                    Manager</a>
                                <!--end::Title-->
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="d-flex flex-wrap align-items-center mb-10">
                        ...
                        <div id="kt_signin_password">
                            ...
                            <div class="fw-semibold text-gray-600">Pemahaman tentang bisnis inti dari perusahaan dan
                                mengoptimalkan peluang-peluang
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Meningkatnya pemahaman peran sebagai pemimpin yang memahami kebutuhan & perasaan
                                    bawahan/orang lain</td>
                                <td>Smt-1 2024</td>
                            </tr>
                        </tbody>
                    </table>
