                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">Herlambang
                                        Syahputera</a>
                                ...
                                <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                    <h6 class="text-muted">IT Section Head - Future Leader [3]</h6>
                                </div>
                                <!--end::Info-->
                            </div>
                            <!--end::User-->
                ...
                <form id="kt_account_profile_details_form" class="form">
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="group" class="form-control form-control-lg form-control-solid"
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="group"
                                    class="form-control form-control-lg form-control-solid"
                                    value="{{ $employee->working_period }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="group"
                                    class="form-control form-control-lg form-control-solid"
                                    value="{{ $employee->last_promote_date }}" readonly>
                            </div>
                        </div>
