                                ...
                                <div class="card-body border-top p-9">
                                        ...
                                        <div class="col-md-9">
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" value="{{ $employee->npk }}"
                                                        readonly>
                                    ...
                                    <div class="row mt-3 g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" value="{{ $employee->grade }}"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body border-top p-4">
                                        <div class="d-flex flex-wrap align-items-center">
                                            <div id="kt_signin_email">
                                                ...
                                                <div class="fw-semibold text-gray-600">Memahami dan mengembangkan
                                                    kompetensi bawahan</div>
                                        ...
                                        <div class="d-flex flex-wrap align-items-center mb-4">
                                            <div id="kt_signin_password">
                                                ...
                                                <div class="fw-semibold text-gray-600">
                                                    Pemahaman tentang bisnis inti dari perusahaan dan mengoptimalkan
                                                    peluang-peluang
                                                    yang ada di dalam/luar organisasi untuk meningkatkan unjuk kerja
                                                    perusahaan.
                                                </div>
                                            </div>
                                        </div>
