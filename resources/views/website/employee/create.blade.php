            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="birthday_date" class="form-control" value="{{ old('birthday_date') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="company_name" class="form-control">
                            ...
                            <option value="Aisin Indonesia" {{ old('company_name') == 'Aisin Indonesia' ? 'selected' : '' }}>
                                Aisin Indonesia
                            </option>
                            <option value="Aisin Indonesia Automotive" {{ old('company_name') == 'Aisin Indonesia Automotive' ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="position_name" class="form-control" value="{{ old('position_name') }}">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" name="aisin_entry_date" class="form-control" value="{{ old('aisin_entry_date') }}">
                        @error('aisin_entry_date') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Working Period</label>
                        <input type="number" name="working_period" class="form-control" min="0" value="{{ old('working_period', 0) }}">
                        @error('working_period') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Company Group</label>
                        <input type="text" name="company_group" class="form-control" value="{{ old('company_group') }}">
                        @error('company_group') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Foundation Group</label>
                        <input type="text" name="foundation_group" class="form-control" value="{{ old('foundation_group') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="last_promote_date" class="form-control" value="{{ old('last_promote_date') }}">
