    ...
    <div id="kt_app_content" class="app-content  flex-column-fluid ">
        ...
        <div id="kt_app_content_container" class="app-container  container-fluid ">
            ...
            <form action="{{ route('employee.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="container">
                    <!-- Card Pertama -->
                    <div class="card mb-4 p-4 shadow-sm rounded-3">
                        <div class="row">
                            <!-- Kolom Kiri -->
                            <div class="col-md-6">
                                <div class="mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card p-4 shadow-sm rounded-3">
                                <h4 class="fw-bold mb-4 text-center">Last Promote Date</h4>
                                ...
                                <div class="text-center mt-3">
                                    <button type="button" class="btn btn-primary" onclick="addPromotion()">Add More</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <div class="card p-4 shadow-sm rounded-3">
                                ...
                                <!-- Button Add More -->
                                <div class="text-center mt-3">
                                    <button type="button" class="btn btn-primary" onclick="addWorkExperience()">Add More</button>
                                </div>
                            </div>
                        </div>
                    </div>
