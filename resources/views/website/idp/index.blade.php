                            ...
                            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_role_scroll"
                                ...
                                <div class="col-lg-12 mb-10">
                                    ...
                                    <select name="idp" aria-label="Select a Country" data-control="select2"
                                        ...
                                        <option data-kt-flag="flags/afghanistan.svg" value="AF">Superior (DGM & GM) +
                                            DIC PUR + BOD Members</option>
                                        <option data-kt-flag="flags/afghanistan.svg" value="AF">Book Reading/ Journal
                                            Business and BEST PRACTICES (Asia Pacific Region)</option>
                                        <option data-kt-flag="flags/aland-islands.svg" value="AX">To find "FIGURE
                                            LEADER" with Strong in Drive and Courage in Their Team --> Sharing Success Tips
                                        </option>
                                        <option data-kt-flag="flags/albania.svg" value="AL">Team Leader of TASK FORCE
                                            with MULTY FUNCTION --> (AII) HYBRID DUMPER Project (CAPACITY UP) & (AIIA) EV
                                            Project</option>
                                        <option data-kt-flag="flags/algeria.svg" value="DZ">SR Project (Structural
                                            Reform --> DM & SCM)</option>
                                        <option data-kt-flag="flags/american-samoa.svg" value="AS">PEOPLE Development
                                            Program of Team members (ICT, IDP)</option>
                                        <option data-kt-flag="flags/afghanistan.svg" value="AF">(Leadership) -->
                                            Courageously & Situational Leadership</option>
                                        <option data-kt-flag="flags/afghanistan.svg" value="AF">(Developing Sub
