...
@section('main')
    <div id="kt_app_content_container" class="app-container  container-fluid">
        <div class="card">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @foreach($alcs as $id => $title)
                                ...
                                @endphp
                                <td class="text-center">
                                    <span class="badge badge-lg {{ ($score >= 3) ? 'badge-success' : 'badge-danger' }} score d-block w-100"
                                        @if($score < 3 && $score !== '-')
                                ...
                                <td class="text-center" style="width: 50px">
                                    <div class="d-flex gap-2 justify-content-center">
                                        <div class="d-flex gap-2">
                                            ...
                                            <button type="button" class="btn btn-sm btn-secondary" data-bs-toggle="modal" data-bs-target="#addEntryModal2">
                                                <i class="fas fa-pen"></i>
                                            </button>

                                            <button type="button" class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#notes_{{ $assessment->id }}">
            ...
            <div class="modal fade" id="kt_modal_warning_{{ $assessment->id }}" tabindex="-1" style="display: none;" aria-modal="true" role="dialog">
                                        ...
                                        <form action="{{ route('idp.store') }}" method="POST">
                                          ...
                                          <input type="hidden" name="assessment_id" value="{{ $assessment->id }}">
                                                ...
                                                <div class="col-lg-12 mb-10">
                                                    ...
                                                    <select id="category_select_{{ $assessment->id }}" name="idp" aria-label="Select a Country" data-control="select2"
                                                ...
                                                <div class="col-lg-12 mb-10">
                                                    ...
                                                    <select id="program_select_{{ $assessment->id }}" name="idp"  aria-label="Select a Country" data-control="select2"
                                                        data-placeholder="Select Programs..."
                                                        class="form-select form-select-solid form-select-lg fw-semibold" multiple>
                                                        <option value="">Select Development Program</option>
                                                        <option data-kt-flag="" value="Superior (DGM & GM)">Superior (DGM & GM) + DIC PUR + BOD Members</option>
                                                        <option data-kt-flag="" value="Book Reading">Book Reading/ Journal Business and BEST PRACTICES (Asia Pacific Region)</option>
                                                        <option data-kt-flag="" value="FIGURE LEADER">To find "FIGURE LEADER" with Strong in Drive and Courage in Their Team --> Sharing Success Tips</option>
                                                        <option data-kt-flag="" value="Team Leader">Team Leader of TASK FORCE with MULTY FUNCTION --> (AII) HYBRID DUMPER Project (CAPACITY UP) & (AIIA) EV Project</option>
                                                        <option data-kt-flag="" value="SR PROJECT">SR Project (Structural Reform --> DM & SCM)</option>
                                                        <option data-kt-flag="" value="People Development Program">PEOPLE Development Program of Team members (ICT, IDP)</option>
                                                        <option data-kt-flag="" value="Leadership">(Leadership) --> Courageously & Situational Leadership</option>
                                                        <option data-kt-flag="" value="Developing Sub Ordinate">(Developing Sub Ordinate) --> Coaching Skill/ Developing Talents</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-lg-12 fv-row mb-5">
                                                    ...
                                                    <input type="date" id="due_date_{{ $assessment->id }}" name="due_date" class="form-control" />
                                    ...
                                    <div id="formContainer">
                                        ...
                                        <div class="entry-group">
                                            <div class="mb-3">
                                                ...
                                                <select id="program_select_{{ $assessment->id }}" name="idp" aria-label="Select a Country"
                                                    ...
                                                    <option value="Superior (DGM & GM)">Superior (DGM & GM) + DIC PUR + BOD Members</option>
                                                    <option value="Book Reading">Book Reading/ Journal Business and BEST PRACTICES (Asia Pacific Region)</option>
                                                    <option value="FIGURE LEADER">To find "FIGURE LEADER" with Strong in Drive and Courage in Their Team --> Sharing Success Tips</option>
                                                    <option value="Team Leader">Team Leader of TASK FORCE with MULTY FUNCTION --> (AII) HYBRID DUMPER Project (CAPACITY UP) & (AIIA) EV Project</option>
                                                    <option value="SR PROJECT">SR Project (Structural Reform --> DM & SCM)</option>
                                                    <option value="People Development Program">PEOPLE Development Program of Team members (ICT, IDP)</option>
                                                    <option value="Leadership">(Leadership) --> Courageously & Situational Leadership</option>
                                                    <option value="Developing Sub Ordinate">(Developing Sub Ordinate) --> Coaching Skill/ Developing Talents</option>
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control developmentAchievement" name="development_achievement[]">
                                            </div>
...
<div class="modal fade" id="addEntryModal2" tabindex="-1" aria-labelledby="addEntryModal2Label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addEntryModal2Label">Add Development One Year</h5>
                    ...
                    <div class="modal-body">
                        <div id="formContainer">
                            <div class="entry-group">
                    <div class="mb-3">
                        <label for="developmentProgram2" class="form-label fw-bold">Development Program</label>
                        <select class="form-select" id="developmentProgram2" name="development_program[]" required>
                            <option value="">-- Select Development Program --</option>
                            <option value="Superior (DGM & GM) + DIC PUR + BOD Members">Superior (DGM & GM) + DIC PUR + BOD Members</option>
                            <option value="Book Reading / Journal Business and BEST PRACTICES (Asia Pasific Region)">Book Reading / Journal Business and BEST PRACTICES (Asia Pasific Region)</option>
                            <option value="To find FIGURE LEADER with Strong in Drive and Courage in Their Team --> Sharing Success Tips">To find "FIGURE LEADER" with Strong in Drive and Courage in Their Team --> Sharing Success Tips </option>
                            <option value="Team Leader of TASK FORCE with MULTY FUNCTION --> (AII) HYBRID DUMPER Project (CAPACITY UP) & (AIIA) EV Project">Team Leader of TASK FORCE with MULTY FUNCTION --> (AII) HYBRID DUMPER Project (CAPACITY UP) & (AIIA) EV Project  </option>
                            <option value="SR Project (Structural Reform -->DM & SCM)">SR Project (Structural Reform -->DM & SCM)</option>
                            <option value="PEOPLE Development Program of Team members (ICT, IDP)">PEOPLE Development Program of Team members (ICT, IDP)</option>
                            <option value="(Leadership) --> Courageously & Situational Leadership">(Leadership) --> Courageously & Situational Leadership </option>
                            <option value="(Developing Sub Ordinate) --> Coaching Skill / Developing Talents">(Developing Sub Ordinate) --> Coaching Skill / Developing Talents</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="evaluationResult2" class="form-label fw-bold">Evaluation Result</label>
                        <input type="text" class="form-control" id="evaluationResult2" name="evaluation_result[]" required>
                    </div>
                </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-2">
                    <form id="kt_modal_update_role_form_{{ $assessment->id }}" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        action="#">
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_role_scroll_{{ $assessment->id }}"
...
document.addEventListener("DOMContentLoaded", function () {
        document.querySelectorAll("form").forEach(form => {
            form.addEventListener("submit", function (e) {
                ...
                const program = form.querySelector('select[name="development_program[]"]').value;
...
document.addEventListener("DOMContentLoaded", function() {
        document.querySelectorAll(".open-modal").forEach(button => {
            button.addEventListener("click", function() {
                ...
                let modal = new bootstrap.Modal(document.getElementById(`notes_${id}`));
                modal.show();
            });
        });
    });
