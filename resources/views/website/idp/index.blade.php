    ...
    <div id="kt_app_content_container" class="app-container  container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    @if (auth()->user()->role == 'HRD')
                        @foreach ($jobPositions as $index => $position)
                            <li class="nav-item" role="presentation">
                                <a class="nav-link text-active-primary pb-4 {{ $index === 0 ? 'active' : '' }}" data-bs-toggle="tab"
                                    data-bs-target="#{{ Str::slug($position) }}" role="tab"
                        ...
                        <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}" id="{{ Str::slug($position) }}"
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-row-dashed fs-6 gy-5">
                                    ...
                                    <tbody>
                                        @php
                                            $filteredEmployees = $position = 'Show All' ? $processedData : $processedData->filter(fn($assessment) => $assessment->employee->position == $position);
                                            $rowNumber = 1; 
                                        @endphp
                                        ...
                                        @forelse ($filteredEmployees as $assessment)
                                            @if ($assessment->has_score)
                                                <tr>
                                                    ...
                                                    @foreach ($alcs as $alcId => $alcTitle)@php
                                                            $detail = $assessment->details->firstWhere('alc_id', $alcId);
                                                        @endphp
                                                                ...
                                                                @if ($detail)
                                                                    ...
                                                                    @else
                                                                        <span class="badge {{ $detail->badge_class }}"
                                                                            ...
                                                                            @if ($detail->show_icon)
                                                                                <i class="fas {{ $detail->idp->isNotEmpty() ? 'fa-check' : 'fa-exclamation-triangle' }} ps-2"></i>
                                                                            @endif
                                                                        </span>
                                                                    @endif
                                                                @else
                                                    ...
                                                    <td class="text-center">
                                                        <span class="badge badge-{{ $assessment->overall_badge['class'] }}"
                                                            style="min-width: 90px; display: inline-block; padding: 0.75rem; text-align: center; font-size: 0.85rem; font-weight: 600; border-radius: 0.375rem; white-space: nowrap;">
                                                    ...
                                                    <td class="text-center" style="width: 50px">
                                                        <div class="d-flex gap-2 justify-content-center">
                                                            @php
                                                                ...
                                                                $exportablePositions = ['Manager', 'GM', 'Act Group Manager', 'Direktur'];
                                                            @endphp
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-750px">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body scroll-y mx-2 mt-5">
                                            ...
                                            <input type="hidden" name="alc_id" id="alc_id_{{ $assessment->id }}_{{ $id }}"
                                                value="{{ $id }}">
                                            ...
                                            <div class="col-lg-12 mb-10">
                                                <label class="fs-5 fw-bold form-label mb-4">Description & Suggestion
                                                    Development
                                                    in {{ $title }}</label>
                                                <div class="border p-4 rounded bg-light mb-5" style="max-height: 400px; overflow-y: auto;">
                                                ...
                                                <!-- Countdown Text -->
                                                <div id="countdownText_{{ $assessment->id }}_{{ $id }}" class="text-dark text-center mb-2">
                                                    Please wait <span class="countdown-seconds">for a</span> seconds...
                                                </div>

                                                <!-- Checkbox -->
                                                <div class="form-check d-none" id="checkboxWrapper_{{ $assessment->id }}_{{ $id }}">
                                            ...
                                            <div class="additional-content d-none" id="additionalContent_{{ $assessment->id }}_{{ $id }}">
                                                <div class="col-lg-12 mb-10">
                                                    <hr>
                                                </div>
                                                ...
                                                <div class="col-lg-12 mb-10">
                                                    ...
                                                    <select id="category_select_{{ $assessmentId?->id }}_{{ $id }}" name="category"
                                                ...
                                                <div class="col-lg-12 mb-10">
                                                    ...
                                                    <select id="program_select_{{ $assessmentId?->id }}_{{ $id }}"
                                                        name="development_program" class="form-select form-select-lg fw-semibold"
                                                        data-control="select2" data-placeholder="Select Programs..." required>
                                                ...
                                                <div class="col-lg-12 fv-row mb-10">
                                                    <label for="target_{{ $assessmentId?->id }}_{{ $id }}"
                                                        ...
                                                        Target</label>
                                                    <textarea id="target_{{ $assessmentId?->id }}_{{ $id }}" name="development_target"
                                                ...
                                                <div class="col-lg-12 fv-row mb-5">
                                                    ...
                                                    <input type="date" id="due_date_{{ $assessmentId?->id }}_{{ $id }}" name="date"
                                                        class="form-control" required value="{{ isset($idp) ? $idp->date : '' }}" />
                                                </div>
                                                ...
                                                <div class="text-center pt-15">
                                                    <button type="button" id="confirm-button-{{ $assessment->id }}-{{ $id }}"
                                                        class="btn btn-primary btn-create-idp interlock-submit"
                                                        data-assessment="{{ $assessmentId?->id }}" data-hav="{{ $weaknessDetail?->id }}"
                                                            ...
                                                            <div class="programItem">
                                                                <div class="mb-3">
                                                                    <label class="form-label fw-bold">Development
                                                                        Program</label>
                                                                    <input type="text" class="form-control" name="development_program[]"
                ...
                <div class="modal fade" id="notesHistory" tabindex="-1" aria-labelledby="notesHistoryLabel" aria-hidden="true">
