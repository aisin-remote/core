            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable" id="kt_table_users">
                ...
                <tbody>
                    <tr class="text-start">
                        ...
                        <td>11A</td>
                        <td><span class="badge badge-light-warning fs-7 fw-bold">Strong Performer</span></td>
                        <td class="text-center">
                            <a href="#" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">
